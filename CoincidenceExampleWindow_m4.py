...
class Ui_CoincidenceExample(object):
    def setupUi(self, CoincidenceExample):
        ...
        self.delayB.setMinimum(-99999999)
        self.delayB.setMaximum(99999999)
        ...
        self.delayA.setMinimum(-99999999)
        self.delayA.setMaximum(99999999)
        ...
        self.delayC.setMinimum(-99999999)
        self.delayC.setMaximum(999999999)
        ...
        self.delayD.setMinimum(-99999999)
        self.delayD.setMaximum(99999999)
        ...
        self.deadTimeB.setMaximum(10000.0)
        ...
        self.deadTimeA.setMaximum(10000000.0)
        ...
        self.saveTime = QtWidgets.QDoubleSpinBox(self.centralwidget)
        self.saveTime.setMinimum(0.1)
        self.saveTime.setMaximum(1000)
        self.saveTime.setProperty("value", 200)
        self.saveTime.setObjectName("saveTime")
        self.gridLayout.addWidget(self.saveTime, 8, 2, 1, 1)
        self.toFileButton = QtWidgets.QPushButton(self.centralwidget)
        self.toFileButton.setObjectName("saveToFileButton")
        self.gridLayout.addWidget(self.toFileButton, 8, 3, 1, 1)
        self.fromFile = QtWidgets.QPushButton(self.centralwidget)
        self.fromFile.setObjectName("fromFile")
        self.gridLayout.addWidget(self.fromFile, 8, 4, 1, 1)
        ...
        self.deadTimeC.setMaximum(10000.0)
        ...
        self.deadTimeD.setMaximum(10000.0)
        ...
        self.IntTime.setMaximum(990000)
        ...
        self.correlationBinwidth.setMaximum(999999999)
        ...
        self.PCRButton = QtWidgets.QPushButton(self.centralwidget)
        self.PCRButton.setObjectName("PCRButton")
        self.horizontalLayout_2.addWidget(self.PCRButton)
        self.triggerScanButton = QtWidgets.QPushButton(self.centralwidget)
        self.triggerScanButton.setObjectName("triggerScanButton")
        self.horizontalLayout_2.addWidget(self.triggerScanButton)
    ...
    def retranslateUi(self, CoincidenceExample):
        ...
        self.label_17.setText(QtWidgets.QApplication.translate("CoincidenceExample", "saveName", None, -1))
        self.label_18.setText(QtWidgets.QApplication.translate("CoincidenceExample", "C", None, -1))
        ...
        self.label_16.setText(QtWidgets.QApplication.translate("CoincidenceExample", "saveTime", None, -1))
        self.label_15.setText(QtWidgets.QApplication.translate("CoincidenceExample", "Dead Time", None, -1))
        self.deadTimeB.setSuffix(QtWidgets.QApplication.translate("CoincidenceExample", " ns", None, -1))
        self.deadTimeA.setSuffix(QtWidgets.QApplication.translate("CoincidenceExample", " ns", None, -1))
        self.saveTime.setSuffix(QtWidgets.QApplication.translate("CoincidenceExample", " s", None, -1))
        self.toFileButton.setText(QtWidgets.QApplication.translate("CoincidenceExample", "toFile", None, -1))
        self.fromFile.setText(QtWidgets.QApplication.translate("CoincidenceExample", "fromFile", None, -1))
        self.label_19.setText(QtWidgets.QApplication.translate("CoincidenceExample", "D", None, -1))
        self.delayC.setSuffix(QtWidgets.QApplication.translate("CoincidenceExample", " ps", None, -1))
        self.triggerC.setSuffix(QtWidgets.QApplication.translate("CoincidenceExample", " V", None, -1))
        self.deadTimeC.setSuffix(QtWidgets.QApplication.translate("CoincidenceExample", " ns", None, -1))
        self.delayD.setSuffix(QtWidgets.QApplication.translate("CoincidenceExample", " ps", None, -1))
        self.triggerD.setSuffix(QtWidgets.QApplication.translate("CoincidenceExample", " V", None, -1))
        self.deadTimeD.setSuffix(QtWidgets.QApplication.translate("CoincidenceExample", " ns", None, -1))
        self.IntType.setItemText(0, QtWidgets.QApplication.translate("CoincidenceExample", "Rolling", None, -1))
        self.IntType.setItemText(1, QtWidgets.QApplication.translate("CoincidenceExample", "Discrete", None, -1))
        self.label_8.setText(QtWidgets.QApplication.translate("CoincidenceExample", "Integration Type", None, -1))
        self.label_7.setText(QtWidgets.QApplication.translate("CoincidenceExample", "Histogram bins", None, -1))
        self.label_6.setText(QtWidgets.QApplication.translate("CoincidenceExample", "Histogram bin width", None, -1))
        ...
        self.label_3.setText(QtWidgets.QApplication.translate("CoincidenceExample", "Integration Time", None, -1))
        self.LogScaleCheck.setText(QtWidgets.QApplication.translate("CoincidenceExample", "Log Scale", None, -1))
        self.correlationBinwidth.setSuffix(QtWidgets.QApplication.translate("CoincidenceExample", " ps", None, -1))
        self.PCRButton.setText(QtWidgets.QApplication.translate("CoincidenceExample", "Filtered PCR", None, -1))
